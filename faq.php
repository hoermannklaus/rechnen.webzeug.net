...
<html>
  <head>
    ...
    <title><?php echo L::faqpage_title . " - " . L::appTitle . " - " . L::domain; ?></title>
        ...
        <div class="row mb-4">
            <div class="col">
                ...
                <div class="jumbotron mt-5 text-center">
                    <h1>
                        <?php echo L::faqpage_header; ?>
                    </h1>
                    <p>
                        <?php echo L::faqpage_introtext; ?>
                    </p>
                    <p>
                        ...
                        <div class="card-header" id="heading<?php echo $faq; ?>">
                            <h2 class="mb-0">
                                <button class="btn btn-link" type="button" data-toggle="collapse" id="faq-<?php echo $faq; ?>" data-target="#collapse<?php echo $faq; ?>" aria-expanded="false" aria-controls="collapse<?php echo $faq; ?>">
                                    <?php $question = "faqpage_".$faq."_question"; echo $counter . ". "; echo call_user_func('L::' . $question); ?>
                                </button>
                            </h2>
                        </div>
                        <div id="collapse<?php echo $faq; ?>" class="collapse" aria-labelledby="heading<?php echo $faq; ?>" data-parent="#accordionFaq">
                            <div class="card-body">
                                <?php $answer = "faqpage_".$faq."_answer"; echo call_user_func('L::' . $answer); ?>
                            </div>
                        </div>
                    </div>
                    <?php $counter++; } ?>
